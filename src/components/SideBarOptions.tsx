...
export const SideBarOption = ({ iconURL, text, active }: sideBarOptionType) => {
    return (
        <div
            className={`${active && "before:bg-blue-100 before:border-l-4 before:w-[calc(100%+53px)] before:h-full before:top-0 before:-left-8 before:absolute before:opacity-80 before:z-10 before:border-blue-500 py-3 px-2 rounded-lg mt-5"} relative flex items-center`}>
