...
const SearchBar = ({ placeholder, outline }: searchBarType) => {
    return (
        <form className={`${outline ? "bg-transparent border-b border-gray-400 rounded-none" : "bg-transparent rounded-lg"} items-center py-2 px-2 w-11/12 max-w-md hidden md:flex`}>
