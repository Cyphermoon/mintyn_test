...
const SearchBar = ({ placeholder, outline }: searchBarType) => {
    return (
        <form className={`${outline ? "flex bg-transparent border-b border-gray-400 rounded-none" : "bg-transparent hidden rounded-lg"} items-center py-2 px-2 w-11/12 max-w-md flex`}>
