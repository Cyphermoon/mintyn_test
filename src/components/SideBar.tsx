...
const SideBar = () => {
    ...
    return (
        <section className={`origin-top-left absolute md:static w-full md:w-[32%] lg:w-[18%] z-30 md:z-[revert] left-0 top-20 block ${navOpened ? "animate-moveIn" : "hidden"} md:animate-none bg-white h-screen py-10 text-left px-8 space-y-8 md:block`}>
